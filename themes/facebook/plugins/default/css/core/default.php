...
<!-- changed margin-top = 5 from 0 for img
.name margin-tom form -2 to 5 -->
.newseed-uinfo {
...
display: inline-block;
float: left;
<!-- extra changes from default theme -->
...
/* changed width from 100 px to 200px*/
.notification-friends .notfi-meta a {
width: 200px;
}
.ossn-notifications-box .notfi-meta,
...
/*thanos karakostas changes on
mobile version notifications-box */

.notifications-box .type-name{
text-align:center;
}
