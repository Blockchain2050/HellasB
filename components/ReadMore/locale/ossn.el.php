...
ossn_register_languages('el', array(
    ...
    'com:readmore:link:more' => ' Περισσότερα...',
    'com:readmore:link:less' => ' ...λιγότερα',
    'com:readmore:balloon:more' => 'Kλικ για περισσότερα',
    'com:readmore:balloon:less' => 'Kλικ για λιγότερα',
