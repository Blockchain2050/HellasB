 ...
 */
$el = array(
	'com:ossn:invite' => 'Προσκαλέστε',			
	'com:ossn:invite:friends' => 'Προσκαλέστε φίλους',
	'com:ossn:invite:friends:note' => 'Προσκαλέστε τους φίλους να συμμετάσχουν σε αυτό το δίκτυο, εισαγάγετε τις διευθύνσεις Email και ένα σύντομο μήνυμα. Θα λάβουν ένα Email που θα περιέχει την πρόσκλησή σας.',
